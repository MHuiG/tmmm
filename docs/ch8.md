...
该人年数据未包括支持和系统测试活动，仅仅是设计和编程。当这些数据采用除以 2，以包括系统测试的活动时，它们与 Harr 的数据非常的接近。![编程工作量是程序规模的函数](./public/figures/ch1/fg8-1.jpg)
...
![编程工作量是程序规模的函数](./public/figures/ch1/fg8-2.jpg)

![编程工作量是程序规模的函数](./public/figures/ch1/fg8-3.jpg)
